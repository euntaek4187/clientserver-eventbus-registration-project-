		...
		while (!done) {
			...
			try {
				...
				case "2":
					...
					break;
				case "3":
					eventBus.sendEvent(new Event(EventId.AddStudents, makeStudentInfo()));
					printLogSend(EventId.AddStudents);
					break;
				case "4":
					eventBus.sendEvent(new Event(EventId.AddCourses, makeCourseInfo()));
					printLogSend(EventId.AddCourses);
					break;
				case "5":
				...
				case "6":
					...
					break;
				case "7":
					eventBus.sendEvent(new Event(EventId.Registration, makeRegistrationInfo()));
